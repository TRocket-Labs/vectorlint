---
title: "Strictness"
description: "Tuning how harshly a rule's check scoring penalizes errors, set in rule frontmatter."
---

**Strictness** is a per-rule setting, configured in a rule's YAML frontmatter, that controls how harshly density scoring penalizes errors in the documents a check rule evaluates.
