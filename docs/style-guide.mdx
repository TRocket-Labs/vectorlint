...
description: Set global style instructions and create targeted rules to review content against your style guide, terminology, and content standards.
---
...
- [Customize style rules](/customize-style-rules) — learn how to write effective rules for your rule pack files
