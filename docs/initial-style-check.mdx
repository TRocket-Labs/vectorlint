...
description: Use VECTORLINT.md to run your first content review without writing any rules.
---
...
For example, a `VECTORLINT.md` rule like "avoid passive voice" gives the LLM general guidance. A rule pack file with a structured prompt and audience context gives it precise, reproducible criteria.
...
- [Defining your style rules](/style-guide) — full reference for rule anatomy, targeting, and examples
