...
VectorLint includes a `VectorLint` preset containing eight `check` rules (AI Pattern, Capitalization, Consistency, Inclusivity, Passive Voice, Repetition, Unsupported Claims, Wordiness). You can use it without setting `RulesPath`:
