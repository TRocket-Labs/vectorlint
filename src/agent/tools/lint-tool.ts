...
export function createLintTool(cwd: string, rules: PromptFile[], provider: LLMProvider): LintTool {
  return {
    name: 'lint',
    description:
      "Run per-page VectorLint evaluation on a single file against a specific rule. Returns score and violations. Use ruleId from the rule's frontmatter id field.",
